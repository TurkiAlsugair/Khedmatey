...
export default function FinishedContent({ order, changeStatus, isFollowUpOrder = false }) {
  ...
  const handleCancel = () => {
    Alert.alert(
      "Cancel Follow-up Order",
      "Are you sure you want to cancel this follow-up order?",
      [
        {
          text: "No",
          style: "cancel",
  ...
  const handleAccept = () => {
    navigation.navigate("PickAppointmentFUS", { 
      order
    });
  };
    ...
    <View style={styles.cont}>
      <View style={[styles.statusContainer, { backgroundColor: colors.bg }]}>
        ...
        <Text style={styles.statusMessage}>
          This order has a follow-up order. Please, accept or cancel it.
        </Text>
      </View>
      ...
      <View style={styles.buttonsContainer}>
        ...
        <Button
          cusStyles={[styles.acceptButton, { backgroundColor: ORDER_STATUS_STYLES.ACCEPTED.text }]}
